    ...
    public partial class Form5 : Form
    {
       ...
       // private string ConnectionString = @"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\Mydatabase\MyDatabase.mdb";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            cmd.Connection = conn;
            cmd.CommandText = "INSERT INTO 104_TB (F_Room, R_Resident_F, R_Resident_L, R_Resident_cardnumber, R_Resident_Email, R_Resident_TP, D_R, M_R, Y_R) VALUES (@F_R,@R_FRe,@R_LRe,@R_cardRe,@R_ReEm,@R_ReTP,@D_R,@M_R,@Y_R)";
